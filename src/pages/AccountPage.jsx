...
function AccountPage() {
  ...
  const navigationItems = [
    ...
    { name: 'My Wishlist', path: '/account/wishlist', icon: 'fas fa-heart' },
    { name: 'My Reviews', path: '/account/reviews', icon: 'fas fa-star' },
    { name: 'Newsletter Subscriptions', path: '/account/newsletter', icon: 'fas fa-envelope' },
    { name: 'Change Password', path: '/account/change-password', icon: 'fas fa-lock' }
  ];
